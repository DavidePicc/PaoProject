#############################################################################
# Makefile for building: PaoProject
# Generated by qmake (3.1) (Qt 6.2.4)
# Project:  PaoProject.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile PaoProject.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = PaoProject1.0.0
DISTDIR = /home/student/Desktop/PaoProject/.tmp/PaoProject1.0.0
LINK          = g++
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		PaoProject.pro ZOO/src/Animal.h \
		...
		ZOO/src/Pavone.h \
		ZOO/src/Struzzo.h \
		ZOO/src/Tartaruga.h ZOO/main.cpp \
		ZOO/src/Animal.cpp \
		ZOO/src/animaltype.cpp \
		ZOO/src/Coccodrillo.cpp \
		ZOO/src/generate.cpp \
...
Makefile: PaoProject.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile PaoProject.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ZOO/src/Animal.h ZOO/src/animaltype.h ZOO/src/Coccodrillo.h ZOO/src/generate.h ZOO/src/Giraffa.h ZOO/src/Leone.h ZOO/src/Pavone.h ZOO/src/Struzzo.h ZOO/src/Tartaruga.h $(DISTDIR)/
	$(COPY_FILE) --parents ZOO/main.cpp ZOO/src/Animal.cpp ZOO/src/animaltype.cpp ZOO/src/Coccodrillo.cpp ZOO/src/generate.cpp ZOO/src/Giraffa.cpp ZOO/src/Leone.cpp ZOO/src/Pavone.cpp ZOO/src/Struzzo.cpp ZOO/src/Tartaruga.cpp $(DISTDIR)/
...
main.o: ZOO/main.cpp ZOO/src/Coccodrillo.h \
		ZOO/src/Animal.h \
		ZOO/src/animaltype.h \
		ZOO/src/Leone.h \
		ZOO/src/Pavone.h \
...
animaltype.o: ZOO/src/animaltype.cpp ZOO/src/animaltype.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o animaltype.o ZOO/src/animaltype.cpp

Coccodrillo.o: ZOO/src/Coccodrillo.cpp ZOO/src/Coccodrillo.h \
		ZOO/src/Animal.h \
		ZOO/src/animaltype.h \
		ZOO/src/generate.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Coccodrillo.o ZOO/src/Coccodrillo.cpp

generate.o: ZOO/src/generate.cpp ZOO/src/generate.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o generate.o ZOO/src/generate.cpp

Giraffa.o: ZOO/src/Giraffa.cpp ZOO/src/Giraffa.h \
		ZOO/src/Animal.h \
		ZOO/src/animaltype.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Giraffa.o ZOO/src/Giraffa.cpp

Leone.o: ZOO/src/Leone.cpp ZOO/src/Leone.h \
		ZOO/src/Animal.h \
		ZOO/src/animaltype.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Leone.o ZOO/src/Leone.cpp

Pavone.o: ZOO/src/Pavone.cpp ZOO/src/Pavone.h \
		ZOO/src/Animal.h \
		ZOO/src/animaltype.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Pavone.o ZOO/src/Pavone.cpp

Struzzo.o: ZOO/src/Struzzo.cpp ZOO/src/Struzzo.h \
		ZOO/src/Animal.h \
		ZOO/src/animaltype.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Struzzo.o ZOO/src/Struzzo.cpp

Tartaruga.o: ZOO/src/Tartaruga.cpp ZOO/src/Tartaruga.h \
		ZOO/src/Animal.h \
		ZOO/src/animaltype.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Tartaruga.o ZOO/src/Tartaruga.cpp
