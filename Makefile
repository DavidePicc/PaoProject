...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		ZOO/Pavone.h \
		ZOO/Struzzo.h \
		ZOO/Tartaruga.h ZOO/Animal.cpp \
		ZOO/animaltype.cpp \
		ZOO/Coccodrillo.cpp \
		ZOO/generate.cpp \
		ZOO/Leone.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ZOO/Animal.h ZOO/animaltype.h ZOO/Coccodrillo.h ZOO/generate.h ZOO/Giraffa.h ZOO/Leone.h ZOO/Pavone.h ZOO/Struzzo.h ZOO/Tartaruga.h $(DISTDIR)/
	$(COPY_FILE) --parents ZOO/Animal.cpp ZOO/animaltype.cpp ZOO/Coccodrillo.cpp ZOO/generate.cpp ZOO/Leone.cpp ZOO/main.cpp $(DISTDIR)/
...
Animal.o: ZOO/Animal.cpp ZOO/Animal.h \
		ZOO/animaltype.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Animal.o ZOO/Animal.cpp

animaltype.o: ZOO/animaltype.cpp ZOO/animaltype.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o animaltype.o ZOO/animaltype.cpp

Coccodrillo.o: ZOO/Coccodrillo.cpp ZOO/Coccodrillo.h \
		ZOO/Animal.h \
		ZOO/animaltype.h \
		ZOO/generate.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Coccodrillo.o ZOO/Coccodrillo.cpp

generate.o: ZOO/generate.cpp ZOO/generate.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o generate.o ZOO/generate.cpp

Leone.o: ZOO/Leone.cpp ZOO/Leone.h \
		ZOO/Animal.h \
		ZOO/animaltype.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Leone.o ZOO/Leone.cpp

main.o: ZOO/main.cpp ZOO/Coccodrillo.h \
		ZOO/Animal.h \
		ZOO/animaltype.h \
		ZOO/Leone.h
